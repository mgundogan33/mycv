                ...
                <div class="card-body">
                    <form class="forms-sample" id="portfolioForm" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="80" id="about" name="about" rows="10">{!! $portfolio->about ?? '' !!}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="description" id="description"
                                placeholder="Description" value={{ $portfolio->description ?? '' }}"">
                            @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    if ($.inArray(type, checkImage) == '-1') {
                        Swal.fire({
                            icon: 'error',
                            title: 'Uyarı !',
                            text: "Seçilen " + files[i].name +
                                "'ine sahip resim belirlenen formatlarda değildir. .png, .jpg, .jpeg formatlarından birisi olmalıdır.",
                            confirmButtonText: "Tamam"
                        });
                        return false;
                    }
