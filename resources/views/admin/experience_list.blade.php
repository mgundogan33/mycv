...
@section('js')
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Başarılı !',
                        text: response.experienceID + " ID'li kayıt durumu " + response
        ...
        $('.deleteEducation').click(function() {
            ...
            Swal.fire({
                title: 'Emin misiniz?',
                text: educationID + "ID'li egitim bilgisini silmek istediğinize emin misiniz",
                icon: 'warning',
