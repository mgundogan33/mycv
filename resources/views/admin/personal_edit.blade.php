...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" id="createEducationForm" method="POST" action="{{ route('personal_update',$information->id) }}"
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="80" id="editorLang" name="languages" rows="10" data-sample="1"
                                      data-sample-short="">
                        ...
                        <button type="submit" class="btn btn-primary mr-2" id="createButton">Güncelle</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    @else
    <div class="alert alert-info"> Şuan Malesef bilgi yok...</div>
    @endif
@endsection
@section('js')
